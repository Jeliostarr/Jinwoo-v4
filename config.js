...
const defaultOwner = '256745538596';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '256745538596' ; // put your number here
...
global.pairingNumber = process.env.BOT_NUMBER || '256745538596' ;  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'An8CUaga#Z5zh5_SY_213q8P8hFygWKgUCZV_vqz4Hdk64s3zShA' ;  // put your session id here
